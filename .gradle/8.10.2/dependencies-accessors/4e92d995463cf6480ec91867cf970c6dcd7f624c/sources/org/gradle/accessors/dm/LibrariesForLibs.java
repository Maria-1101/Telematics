...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final Hbb20LibraryAccessors laccForHbb20LibraryAccessors = new Hbb20LibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>androidVolley</b> with <b>com.android.volley:volley</b> coordinates and
     * with version reference <b>volley</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getAndroidVolley() {
        return create("androidVolley");
    }

    /**
     * Dependency provider for <b>curvedbottomNavigation</b> with <b>com.github.qamarelsafadi:CurvedBottomNavigation</b> coordinates and
     * with version reference <b>bottom.nav</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getCurvedbottomNavigation() {
        return create("curvedbottomNavigation");
    }

    /**
     * Dependency provider for <b>firebaseService</b> with <b>com.google.firebase:firebase-database</b> coordinates and
     * with version reference <b>firebase</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getFirebaseService() {
        return create("firebaseService");
    }

    /**
     * Dependency provider for <b>glide</b> with <b>com.github.bumptech.glide:glide</b> coordinates and
     * with version reference <b>glide.ref</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    /**
     * Dependency provider for <b>okhttpService</b> with <b>com.squareup.okhttp3:okhttp</b> coordinates and
     * with version reference <b>okhttpVersion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getOkhttpService() {
        return create("okhttpService");
    }

    /**
     * Dependency provider for <b>serviceLocation</b> with <b>com.google.android.gms:play-services-location</b> coordinates and
     * with version reference <b>location</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getServiceLocation() {
        return create("serviceLocation");
    }
    ...
    /**
     * Group of libraries at <b>hbb20</b>
     */
    public Hbb20LibraryAccessors getHbb20() {
        return laccForHbb20LibraryAccessors;
    }
    ...
    public static class Hbb20LibraryAccessors extends SubDependencyFactory {

        public Hbb20LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final BottomVersionAccessors vaccForBottomVersionAccessors = new BottomVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>firebase</b> with value <b> 20.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.bottom</b>
         */
        public BottomVersionAccessors getBottom() {
            return vaccForBottomVersionAccessors;
        }
    ...
    public static class BottomVersionAccessors extends VersionFactory  {

        public BottomVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>bottom.nav</b> with value <b>0.1.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNav() { return getVersion("bottom.nav"); }
    ...
    public static class GlideVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>glide.ref</b> with value <b>4.16.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRef() { return getVersion("glide.ref"); }
    ...
    public static class GooglePluginAccessors extends PluginFactory {
         ...
         * with version reference <b>service</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
